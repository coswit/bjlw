 ...
 */
public class SearchKeywordAct extends BaseLoadAct {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mKeyword = intent.getStringExtra(Keys.SEARCH_KEYWORD);
    ...
    public void initData() {
        if (mKeyword != null) {
            initListDatas(mKeyword);

        }
    }

    private void initListDatas(String keyword) {
        String requestUrl = NetUrls.HOST + NetUrls.SEARCH_KEYWORD_ACT;
        RequestParams params = new RequestParams(requestUrl);
        params.addBodyParameter(NetUrls.KEYWORD,keyword);
        ...
        public void onBindViewHolder(MyReclerViewHolder holder, final int position) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                   ...
                   SearchKeywordAct.this.startActivity(intent);
                    SearchKeywordAct.this.overridePendingTransition(R.anim.enter_anim, R.anim.exit_anim);
                }
            });
