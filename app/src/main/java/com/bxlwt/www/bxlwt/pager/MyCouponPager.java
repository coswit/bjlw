...
/**
 * Created by zhengj on 2016/8/30.
 */
public class MyCouponPager extends BasePager {
    private RecyclerView mRecyclerView;


    public MyCouponPager(Context context) {
        super(context);
    }

    public MyCouponPager(Context context, List result) {
    ...
    class MyReclerViewAdapter extends RecyclerView.Adapter<MyReclerViewAdapter.MyReclerViewHolder> {
        ...
        public MyReclerViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            itemView.setBackgroundResource(R.mipmap.coupon);
        ...
        public void onBindViewHolder(MyReclerViewHolder holder, int position) {
           List<MyCouponBean.DataBean> info = MyCouponPager.this.mDatas;
